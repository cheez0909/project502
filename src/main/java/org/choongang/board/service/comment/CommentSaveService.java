...
import org.choongang.board.controllers.comment.CommentNotFoundException;
...
public class CommentSaveService {
    ...
    // 반환값을 void -> CommentDat로 변경
    // 댓글 작성 후 댓글창으로 이동하기 위해서
    public CommentData save(RequestComment form){
        ...
        if(mode.equals("edit") && seq != null) { // 댓글 수정
            ...
            data.setIp(request.getRemoteAddr()); // ip 정보
